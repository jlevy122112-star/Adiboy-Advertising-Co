...
| **P3** | **Postgres + Redis**; BullMQ publish/retry |
...
| **P7** | Scale & SRE (load tests, observability, runbooks) — detail in [`marketer-pro-p7-scale-assets.md`](./marketer-pro-p7-scale-assets.md) |
