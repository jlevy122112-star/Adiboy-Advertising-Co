...
Path: /workspaces/Marketer-Pro
Runtime: Node.js
Package Manager: NPM
Version Control: https://github.com/jlevy122112-star/Marketer-Pro
Purpose: Marketer-Pro — merge full upstream workspace definitions when syncing from canonical remote.
...
- @~/.claude/Marketer-Pro-preferences.md
