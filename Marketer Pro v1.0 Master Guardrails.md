...
- Every metric has a recommended action attached
- Cross-platform comparison always visible

### Phase 6 — Rate and Learn
- Thumbs up or thumbs down after every post goes live
...
- Atomic component design — every element is a reusable building block
...
- Loading states use skeleton screens — never blank white flashes
...
[Create Tab] Redesign AI Studio with 3-step platform picker flow
[Plan Tab] Fix calendar day cell height on mobile screens
[Analyze Tab] Add recommended action to every analytics metric
[Settings Tab] Add competitor field to brand profile panel
[Bug Fix] Fix horizontal overflow on calendar grid mobile
[Infra] Add missing VITE environment variables to web env file
```
